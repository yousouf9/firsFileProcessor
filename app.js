...
//app.use('/', indexRouter);
 ...
 require('./etisalat').etisalatPath()
 require('./billyronks/mtn/index').BillyRonkPath()
 require('./billyronks/ninemobile/index').BillyRonkPath()
 require('./billyronks/airtel/index').BillyRonkPath()
